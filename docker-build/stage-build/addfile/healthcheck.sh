...
FIRST=$($CCLI query tip --shelley-mode --testnet-magic $(jq .networkMagic /opt/cardano/cnode/files/genesis.json) | jq .blockNo)

sleep 60;

SECOND=$($CCLI query tip --shelley-mode --testnet-magic $(jq .networkMagic /opt/cardano/cnode/files/genesis.json) | jq .blockNo)
